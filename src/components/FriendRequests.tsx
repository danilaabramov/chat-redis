        ...
        {!friendRequests.length ?
            ...
            friendRequests.map((request) => (
                    <div key={request.senderId} className='flex gap-4 items-center'>
                        ...
                        <button onClick={() => acceptFriend(request.senderId)} aria-label='accept friend'
                        ...
                        <button onClick={() => denyFriend(request.senderId)} aria-label='deny friend'
                                className='w-8 h-8 bg-red-600 hover:bg-red-700 grid place-items-center rounded-full
