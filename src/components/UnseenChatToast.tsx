...
const UnseenChatToast: FC<UnseenChatToastProps> =
    ({t, senderId, sessionId, senderImg, senderName, senderMessage}) => {
        return <div className={cn('max-w-md w-full bg-white shadow-lg rounded-lg pointer-events-auto flex ring-1 ' +
            'ring-black ring-opacity-5', {'animate-enter': t.visible, 'animate-leave': !t.visible})}>
